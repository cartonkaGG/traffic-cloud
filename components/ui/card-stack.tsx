  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.tag ? (
          <span className="mb-2 w-fit rounded-full border border-white/20 bg-black/40 px-2.5 py-0.5 text-[10px] font-medium uppercase tracking-wider text-white/80 backdrop-blur-sm">
            {item.tag}
          </span>
        ) : null}
        ...
        {item.ctaLabel ? (
          <p className="mt-2 text-xs font-medium text-white/60">{item.ctaLabel}</p>
        ) : null}
      </div>
    </div>
  );
